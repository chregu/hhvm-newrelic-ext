...
This branch of the extension is known to work with HHVM 3.4 and theoretically also HHVM 3.3. We recommend using HHVM 3.5 or 3.6 from the master branch. For older HHVM versions, see the other branches.
